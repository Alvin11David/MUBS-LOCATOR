...
class Building {
  ...
  factory Building.fromFirestore(Map<String, dynamic> json, String docId) {
    ...
    if (locationData == null) {
      throw Exception('Building $docId is missing location data');
    }

    // Handle both Map and GeoPoint from Firestore
    double latitude;
    double longitude;
    ...
    if (locationData is Map) {
      ...
      // Handle GeoPoint if you're using Firestore GeoPoint type
      throw Exception('Unexpected location format for building $docId');
    }

    if (latitude == 0.0 && longitude == 0.0) {
      throw Exception('Invalid coordinates (0,0) for building $docId');
    }

    return Building(
      id: docId,
      name: json['name'] ?? 'Unknown Building',
...
final List<Building> mubsBuildings = [
  Building(
    id: "",
    name: "Administartion Office block",
    description: "dummy description",
    location: LatLng(0.32901956889177686, 32.61612989315701),
  ),
  Building(
    id: "",
    name: "Mubs Main Building",
    description: "dummy description",
    location: LatLng(0.32689514423557686, 32.61657359573117),
  ),
  Building(
    id: "",
    name: "Entrepreneurship Center",
    description: "dummy description",
    location: LatLng(0.32874047379750837, 32.61796834434454),
  ),
  Building(
    id: "",
    name: "MUBS Resource Centre",
    description: "dummy description",
    location: LatLng(0.3277245860439169, 32.6175108582803),
  ),
  Building(
    id: "",
    name: "MUBS Playground",
    description: "dummy description",
    location: LatLng(0.32708234423157934, 32.61862206689591),
  ),
  Building(
    id: "",
    name: "Guild Office Block",
    description: "dummy description",
    location: LatLng(0.32836936277880574, 32.618437788834996),
  ),
  Building(
    id: "",
    name: "MUBS Mosque",
    description: "dummy description",
    location: LatLng(0.3284409588418777, 32.61886143806034),
  ),
  Building(
    id: "",
    name: "MUBS Digital Library",
    description: "dummy description",
    location: LatLng(0.3277212015391435, 32.616415297579685),
  ),
  Building(
    id: "",
    name: "Block 7",
    description: "dummy description",
    location: LatLng(0.32739934172355317, 32.6160612460086),
  ),
];
