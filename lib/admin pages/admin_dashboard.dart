        ...
        child: Stack(
          children: [
            ...
            if (_isDropdownVisible)
              Positioned(
                top: screenHeight * 0.09, // Position below the glassy rectangle
            ...
            Positioned(
              top: screenHeight * 0.11, // Slightly below the glassy rectangle
            ...
            Positioned(
              top: screenHeight * 0.16, // Below Dashboard Overview with small gap
              left: screenWidth * 0.04, // Align with left padding
              child: Container(
            ...
            Positioned(
              top: screenHeight * 0.32, // Below the cards
              left: screenWidth * 0.04, // Align with left padding
              child: Text(
                'Location Management',
                style: TextStyle(
            ...
            Positioned(
              top: screenHeight * 0.37, // Below Location Management text
              left: screenWidth * 0.04, // Align with left padding
              child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          ...
                          errorBuilder: (context, error, stackTrace) => Icon(
                            Icons.error,
                            color: Colors.red,
                            size: screenWidth * 0.1, // Match image size for error icon
                          ),
                        ),
                      ),
                    ),
