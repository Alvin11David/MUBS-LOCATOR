                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    // Circular container with profile image or person icon
                                    Padding(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Table(
                                    ...
                                    children: [
                                      ...
                                      ...docs.map((doc) {
                                        // Safely access the 'name' and 'description' fields
                                        final name =
                                            doc.get('name') as String? ?? 'Unnamed';
                                        final description =
                                            doc.get('description') as String? ?? 'No description';
                                        return TableRow(
                                          children: [
                                            Padding(
                                              padding: EdgeInsets.all(
